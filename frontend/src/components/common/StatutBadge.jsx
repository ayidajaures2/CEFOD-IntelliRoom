...
const STYLES = {
  libre: "bg-paper text-ink border border-ink/20",
  reservee: "bg-accent-soft text-accent-dark border border-accent/40",
  occupee: "bg-accent text-paper",
  en_attente: "bg-paper text-ink/70 border border-dashed border-ink/30",
  ...
  annulee: "bg-paper text-ink/40 border border-ink/15 line-through",
  valide: "bg-ink text-paper",
  annule: "bg-paper text-ink/40 border border-ink/15",
};
